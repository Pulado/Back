...
Route::delete('/termo/{palavras-do-termo}', [termoController::class, 'destroy']);

// Rota para atualizar um termo inteiro
Route::path('/termo/{palavras-do-termo}', [termoController::class, 'update']);


// Rota para atualizar um termo parcialmente
Route::put('/termo/{palavras-do-termo}', [termoController::class, 'put']);