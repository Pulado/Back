...
class termoController extends Controller{
       ...
       public function show($palavrasdotermo)
    {
        ...
        public function update(Request $request,  termo $palavrasdotermo)
     {
        $validatedData = $request->validate([
            'palavras-do-termo' => 'string',
        ...
        $palavrasdotermo->update($validatedData);

        return response()->json($palavrasdotermo, 200);
    }

    
    public function destroy(termo $palavrasdotermo)
    {
        $palavrasdotermo->delete();

        return response()->json(null, 204);
    }
         public function put(Request $request,  termo $palavrasdotermo)
     {
        $validatedData = $request->validate([
